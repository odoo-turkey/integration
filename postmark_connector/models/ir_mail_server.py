...
class IrMailServer(models.Model):
    ...
    def connect(self, host=None, port=None, user=None, password=None, encryption=None, smtp_debug=False,
                mail_server_id=None, ):
    ...
    def send_email(self, message, mail_server_id=None, smtp_server=None, smtp_port=None,
        ...
        if "postmark" not in mail_server.smtp_host:
            return super(IrMailServer, self).send_email(message, mail_server_id=None, smtp_server=None, smtp_port=None,
