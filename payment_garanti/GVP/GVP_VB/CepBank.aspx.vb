...
Partial Public Class CepBank
    ...
    Protected Sub cmdSubmit_Click(ByVal sender As Object, ByVal e As EventArgs) Handles cmdSubmit.Click
        ...
        Dim strProvisionPassword As String = "XXXXXXX" 'TerminalProvUserID şifresi
        ...
        Dim strType As String = "cepbank" 'CepBank satış işlemleri için bu type kullanılmalı
