...
Partial Public Class CepBank_Bonus
    ...
    Protected Sub cmdSubmit_Click(ByVal sender As Object, ByVal e As EventArgs) Handles cmdSubmit.Click
        ...
        Dim strPaymentType As String = ddlPaymentType.SelectedValue
        Dim strAmount As String = "100" 'İşlem Tutarı
        Dim strType As String = "cepbankbns" 'CepBank bonus sorgulama işlemleri için bu tip kullanılmalı
