...
Partial Public Class OOSPay
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Dim strOrderID As String = "DENEME12"  'her iþlemde farklý bir deðer gönderilmeli
            ...
            Dim _strTerminalID As String = "0" & strTerminalID 'Baþýna 0 eklenerek 9 digite tamamlanmalýdýr.
            Dim strTerminalMerchantID As String = "XXXXXXXX" 'Üye Ýþyeri Numarasý
            Dim strStoreKey As String = "XXXXXXXX" '3D Secure þifreniz
            Dim strProvisionPassword As String = "XXXXXXXX" 'TerminalProvUserID þifresi
