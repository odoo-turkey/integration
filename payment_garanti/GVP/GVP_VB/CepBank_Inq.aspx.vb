...
Partial Public Class CepBank_Inq
    ...
    Protected Sub cmdSubmit_Click(ByVal sender As Object, ByVal e As EventArgs) Handles cmdSubmit.Click
        ...
        Dim strProvisionPassword As String = "XXXXXX" 'Terminal UserID şifresi
        ...
        Dim strAmount As String = "100" 'İşlem Tutarı
        Dim strType As String = "cepbankinq" 'CepBank sorgulama işlemleri için bu tip kullanılmalı
        Dim strPaymentType As String = "K" ' Bonus kazanım değerinin dönmesi için K veya D değerini göndermelisiniz.
        ...
        PaymentType.AppendChild(doc.CreateTextNode(strPaymentType))
        CepBank.AppendChild(PaymentType)

        Dim cepbankInq As System.Xml.XmlElement
        cepbankInq = doc.CreateElement("CepbankInq")
        Transaction.AppendChild(cepbankInq)

        Dim _GSMNumber As System.Xml.XmlElement
        _GSMNumber = doc.CreateElement("GSMNumber")
        _GSMNumber.AppendChild(doc.CreateTextNode(strGSMNumber))
        cepbankInq.AppendChild(_GSMNumber)
