...
<body>
    <%
        ...
        strProvisionPassword = "" 'TerminalProvUserID þifresi
        strUserID = "XXXXXX" 'SanaPos Kullanýcý Adýnýz
        strMerchantID = "XXXXXX" 'Üye Ýþyeri Numarasý
        strCustomerName = "Yahya EKÝNCÝ"
        strIPAddress = Request.ServerVariables("REMOTE_ADDR")
        strEmailAddress = "eticaret@garanti.com.tr"
        strOrderID = "Deneme" 'Her sipariþ için unique bir deðer gönderilmelidir.
