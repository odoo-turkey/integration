<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Orderlistinq.aspx.cs" Inherits="$safeprojectname$.Orderlistinq" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <asp:Button ID="cmdSubmit" runat="server" Text="Sorgula" onclick="cmdSubmit_Click" />
        <br /><br />
