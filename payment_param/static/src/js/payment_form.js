...
odoo.define('payment_param.payment_form', require => {
    'use strict';
    ...
    const paymentParamMixin = {
        ...
        /**
         * Prepare the inline form of Param for direct payment.
         *
         * @override method from payment.payment_form_mixin
         * @private
    ...
    checkoutForm.include(paymentParamMixin);
    manageForm.include(paymentParamMixin);
});