...
TEST_URL = "https://test-dmz.param.com.tr/turkpos.ws/service_turkpos_test.asmx?wsdl"

PARAM_ERROR_CODES = {
    1: "Başarılı",
    -1: "Başarısız",
    -100: "Hesap bulunamadı.",
    -101: "Güvenlik Hatası(IP bilgisinin tanımlı olmaması"
          " ya da entegrasyon bilgilerinin eksik/hatalı"
          " girilmesinden kaynaklanmaktadır.",
    ...
    -112: "Tutar formatı geçersiz. Nokta kullanmayınız."
          " Kuruş formatında virgüllü gönderiniz.",
    ...
    -215: "SanalPOS_ID ile Kredi Kartı BIN kodu uyumsuz."
          " Kredi Kartı markasına göre yanlış SanalPOS_ID seçiliyor.",
    ...
    -226: "Girilen SanalPos İşlem numarasının Pos ödemesi başarılı"
          " sonuç vermediği için kayıt yapılmadı."
          " Pos metodundan başarısız geçen işlem Siparis olarak eklenemez.",
